...
contract PrixedictBoostSystem is Ownable {
    
    IPrixedictPoolCore public poolCore;
    ...
    // PRIX boost fees (1:6 ratio: 1 BNB = 6 PRIX)
    uint256[4] public prixBoostFees = [0, 12e18, 30e18, 60e18]; // NONE, BRONZE, SILVER, GOLD
    ...
    constructor(address _poolCore, address _revenueCollector) Ownable(msg.sender) {
        ...
        poolCore = IPrixedictPoolCore(_poolCore);
    ...
    function boostPool(uint256 poolId, BoostTier tier) external payable {
        ...
        (address creator,,,,,,,,,,,,,,,,,,,) = poolCore.getPool(poolId);
        require(msg.sender == creator, "Only creator can boost");
        ...
        // Charge boost fee (native BNB only)
