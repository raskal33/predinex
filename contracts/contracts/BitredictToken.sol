...
contract PrixedictToken is ERC20, Ownable {
    uint256 public constant MAX_SUPPLY = 100_000_000 * 1e18; // 100M PRIX
    bool public mintingFinished = true; // No future minting allowed
    
    constructor() ERC20("Prixedict", "PRIX") Ownable(msg.sender) {
