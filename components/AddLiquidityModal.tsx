...
export default function AddLiquidityModal({ pool, isOpen, onClose }: AddLiquidityModalProps) {
  ...
  const handleAddLiquidity = async () => {
    ...
    try {
      ...
      await addLiquidity(pool.id, liquidityAmount, pool.usesPrix);
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-0 bottom-0 z-[110] bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 border-t-2 border-rose-500/30 rounded-t-3xl shadow-2xl max-h-[85vh] overflow-hidden"
          >
            {/* Drag Handle */}
            ...
            <div className="overflow-y-auto max-h-[calc(85vh-180px)] px-4 py-3">
              ...
              {addSuccess && (
                <motion.div
                  ...
                  className="absolute inset-0 z-[120] flex items-center justify-center bg-gradient-to-br from-green-500/20 via-rose-500/20 to-pink-500/20 backdrop-blur-sm rounded-t-3xl"
                >
                  <motion.div
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-gray-800/50 rounded-lg border border-gray-700/50">
                  ...
                  <div className="flex items-center justify-between mt-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-semibold text-white">{pool.usesPrix ? "PRIX" : "tBNB"}</div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">
                    Amount ({pool.usesPrix ? "PRIX" : "tBNB"})
                  </label>
                  <input
                    type="number"
